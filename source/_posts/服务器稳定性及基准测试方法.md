...
# 修改为
LAdir   = /usr/lib64/openblas  # 你的 OpenBLAS 安装路径，find / -name openblas
LAinc   =
LAlib   = -lopenblas
...
fio -name=disk_benchmark -size=10G -runtime=5m -time_base -direct=1 -ioengine=libaio -randrepeat=0 -numjobs=8 -group_reporting -bs=4k -rw=randrw -rwmixwrite=30 -directory=/home/fio/ -iodepth=1
```
